      ...
      for (var _i3 = 0; _i3 < el.attributes.length; _i3++) {
        ...
        if (bits[1] === "lax") {
          if (_a.name === "data-lax-anchor") {
            ...
            (function () {
              var tString = _a.value.replace(/vw/g, window.innerWidth).replace(/vh/g, window.innerHeight).replace(/elh/g, el.clientHeight).replace(/elw/g, el.clientWidth).replace(/ah/g, o["data-lax-anchor"].clientHeight).replace(/aw/g, o["data-lax-anchor"].clientWidth).replace(/\s+/g, " ");
