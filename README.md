THIS IS A FORK FROM https://github.com/alexfoxy/laxxx
All ive added in this fork is anchor-element special values.
So besides vh, elh etc. you can also write ah/aw (for anchored elements height/width)
...
| aw     	| anchorElement.clientWidth |
| ah     	| anchorElement.clientHeight |
